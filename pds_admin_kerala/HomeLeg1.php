...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Kerala PDS Route Optimisation</li>
</ul>
<!-- END BREADCRUMB -->
<div>
					...
					<div class="form-group">
						...
						<div class="col-md-9">  
							...
							<select class="form-control" id="type" name="type" style="border-radius:5px;font-weight:bold">
								...
								<option value='all_Commodities_from_fci' style="font-weight:bold;color:#000;">All Commodities from FCI</option>
								<option value='Rice-Mill-FCI-Wheat, FRice-FCI' style="font-weight:bold;color:#000;">Rice-Mill-FCI-Wheat, FRice-FCI</option>
